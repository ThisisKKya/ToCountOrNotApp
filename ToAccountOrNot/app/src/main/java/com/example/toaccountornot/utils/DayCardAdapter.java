...
public class DayCardAdapter extends RecyclerView.Adapter<DayCardAdapter.ViewHolder> {
    ...
    public DayCardAdapter(List<Day> dayList, Context context){
        mContext = context;
        mDayList = dayList;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        singleList = initSinglelist(day.getDate(),day.getCard());
    ...
    public List<Single> initSinglelist(String date,String card) {
        ...
        List<Accounts> list = LitePal.where("date=? and card=?", date,card)
                .order("id desc")
                .find(Accounts.class);
